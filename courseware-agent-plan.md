...
| 1 | Player Runtime 核心播放器 | 已完成 | 2026-07-18 | 通过 | GSAP 播放器+转场+授课工具层 |
| 2 | 文档解析服务 | 已完成 | 2026-07-18 | 通过 | MD/TXT/Word/PDF(pdfjs) 解析，落 SQLite |
| 3 | AI 生成 Pipeline | 已完成 | 2026-07-18 | 通过 | v2 两阶段管线（教学脚本→蓝图→装配），见 docs/PRODUCTION_UPGRADE_DESIGN.md 附录A |
| 4 | 可视化编辑器 | 已完成 | 2026-07-18 | 通过 | Block级编辑+大纲视图+主题切换+AI侧边栏+组件面板 |
| 5 | 高级交互组件 | 已完成 | 2026-07-18 | 通过 | 7 互动组件+白板/激光笔/聚光灯/放大镜/TTS |
| 6 | 图片处理与配图 | 已完成 | 2026-07-18 | 通过 | seedream 2K 配图本地化+学科风格统一 |
| 7 | 导出与模板系统 | 已完成 | 2026-07-18 | 通过 | 单文件HTML离线导出+26版式组件库+14主题 |
